...
if($varsesion == null || $varsesion = '' || $varsesionEmpleado){
	...
	<head>
		...
		<title>App Travel Cg | Registrar Servicio</title>
		<!-- Site favicon -->
			...
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="nuevo-sitio.php">Registrar Nuevo Sitio</a></li>
		...
		<div class="col-md-6 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">Registrar Nuevo Servicio</li>
				</ol>
			</nav>
		</div>
		<form action="../acciones/insertarServicio.php" method="post">
			...
			<div class="form-group row">
				<div class="col-sm-12 col-md-6">
					...
					<input class="form-control" name="imagen" type="text" placeholder="URL de la Imagen">
				</div>
				<div class="col-sm-12 col-md-6">
					...
					<select class="custom-select col-12" name="categoria">
						<option selected hidden>Elige la categoria del servicio</option>
			...
			<div class="form-group row">
				<div class="col-sm-12 col-md-12">
					...
					<textarea class="form-control" name="descripcion" type="text" placeholder="Descripción"></textarea>
				</div>
			</div>
