...
if($varsesion == null || $varsesion = '' || $varsesionEmpleado){
	...
	<head>
		...
		<title>App Travel Cg | Editar Sitio</title>
		<!-- Site favicon -->
...
<?php
    ...
    //MOSTRAMOS LISTA
        ...
        $id=$_GET['id'];
        $sql="SELECT * FROM tbSitios WHERE idSitio = '$id'";
...
<body>
    ...
    <div class="col-md-6 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a>Lista Sitios</a></li>
					<li class="breadcrumb-item active" aria-current="page">Editar Sitio</li>
				</ol>
			</nav>
	    </div>
		<form action="../acciones/modificarSitio.php" method="post">
        <?php  while ($row = $datos->fetch_assoc()) {?>
        	<div class="form-group row">
                <label class="col-sm-12">Código</label>
				<div class="col-sm-12 col-md-1">
					<input class="form-control" readonly="readonly" name="id" type="text" value="<?php echo $row['idSitio']; ?>">
				</div>
			</div>
			<div class="form-group row">
				<div class="col-sm-12 col-md-6">
					<label class="col-sm-12" style="font-size: 15px; font-weight: 600; font-family: system-ui;">Nombre del sitio</label>
					<input class="form-control" name="nombre" type="text" value="<?php echo $row['nomSitio']; ?>">
				</div>
				<div class="col-sm-12 col-md-6">
					<label class="col-sm-12" style="font-size: 15px; font-weight: 600; font-family: system-ui;">Ubicación</label>
					<input class="form-control" name="ubicacion" type="text" value="<?php echo $row['ubiSitio']; ?>">
				</div>
			</div>
			<div class="form-group row">
				<div class="col-sm-12 col-md-6">
					<label class="col-sm-12" style="font-size: 15px; font-weight: 600; font-family: system-ui;">Imagen</label>
					<input class="form-control" name="imagen" type="text" value="<?php echo $row['urlSitio']; ?>">
				</div>
				
				<div class="col-sm-12 col-md-6">
					<label class="col-sm-12" style="font-size: 15px; font-weight: 600; font-family: system-ui;">Imagen 360°</label>
					<input class="form-control" name="imagen360" type="text" value="<?php echo $row['url360Sitio']; ?>">
				</div>
			</div>
			<div class="form-group row">
				<div class="col-sm-12 col-md-12">
				<label class="col-sm-12" style="font-size: 15px; font-weight: 600; font-family: system-ui;">Descripción</label>
					<input class="form-control" name="descripcion" type="text" value="<?php echo $row['desSitio']; ?>">
				</div>
			</div>
			<div class="form-group row">
				<div class="col-sm-12 col-md-3">
					<label class="col-sm-12" style="font-size: 15px; font-weight: 600; font-family: system-ui;">Horario de Atención</label>
					<input class="form-control" name="atencion" type="time" value="<?php echo $row['atencionSitio']; ?>">
				</div>
				<div class="col-sm-12 col-md-3">
					<label class="col-sm-12" style="font-size: 15px; font-weight: 600; font-family: system-ui;">Latitud</label>
					<input class="form-control" name="latitud" type="text" placeholder="Latitud" value="<?php echo $row['latiSitio']; ?>">
				</div>
				<div class="col-sm-12 col-md-3">
					<label class="col-sm-12" style="font-size: 15px; font-weight: 600; font-family: system-ui;">Longitud</label>
					<input class="form-control" name="longitud" type="text" placeholder="Longitud" value="<?php echo $row['longSitio']; ?>">
				</div>
				<div class="col-sm-12 col-md-3">
					...
					<select class="custom-select col-12" name="estado">
						<option selected hidden><?php echo $row['estadoSitio'] ?> </option>
            ...
            <a href="../listas/lista-sitios.php" class="btn btn-dark">Cancelar</a>
		</form>
	</div>
