...
if($varsesion == null || $varsesion = '' || $varsesionEmpleado){
	...
	<head>
		...
		<title>App Travel Cg | Listas de Sitios</title>
		<!-- Site favicon -->
...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>App Travel Cg | Lista de Sitios</title>
...
<body>
        ...
        <div class="col-md-6 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">Lista de Sitios</li>
				</ol>
			</nav>
	    </div>
    ...
    <div class="card-box mb-30">
      <div class="pd-20">
      <h4 class="text-blue h4">Lista de Sitios // App Travel Cg</h4>
      </div>
      <div class="pb-20">
        ...
        <thead>
          ...
          <?php  while ($row = $datos->fetch_assoc()) {?>
                    <tr class="table-plus">
                    <td><?php echo $row['nomSitio']; ?></td>
                        <td><?php echo $row['ubiSitio']; ?></td>
						<?php
						if($row['estadoSitio']=='1'){
							?>
						...
						?>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
								<a class="dropdown-item" href="../formularios/modificarSitio.php?id=<?php echo $row['idSitio'];?>"><i class="dw dw-edit2"></i> Editar</a>
								<a class="dropdown-item" href="../acciones/eliminarSitio.php?id=<?php echo $row['idSitio'];?>"><i class="dw dw-delete-3"></i> Eliminar</a>
								</div>
							</div>
                            </td>
                    </tr>
