...
if($varsesion == null || $varsesion = '' || $varsesionEmpleado){
	...
	<head>
		...
		<title>App Travel Cg | Reportes Sitios</title>
		<!-- Site favicon -->
...
<body>
			...
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
                            <li><a href="reportes-avances.php">Reportes Sitios</a></li>
                            <li><a href="reportes-servicios.php">Reportes Servicios</a></li>
        ...
        <div class="col-md-6 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">Reportes de Sitios</li>
				</ol>
			</nav>
		</div>
    ...
    <div class="card-box mb-30">
      <div class="pd-20">
      <h4 class="text-blue h4">Reporte de Sitios // App Travel Cg</h4>
      </div>
      <div class="pb-20">
        ...
        <thead>
          ...
          <?php  while ($row = $datos->fetch_assoc()) {?>
                    <tr class="table-plus">
					  ...
					  <td><?php echo $row['atencionSitio']; ?></td>
                    </tr>
                  <?php }?>
          <thead>
            <tr>
